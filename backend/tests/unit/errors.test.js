...
describe('ErrorCode - 认证授权类 (1xxx)', () => {
  it('AUTH_MISSING_API_KEY 应该正确配置', () => {
...
describe('createError', () => {
  ...
  it('未知错误名称应该返回 SYSTEM_UNEXPECTED_ERROR', () => {
...
describe('safeAsync', () => {
  ...
  it('抛出普通错误的函数应该包装为 SYSTEM_INTERNAL_ERROR', async () => {
    try {
