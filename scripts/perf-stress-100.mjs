...
const DURATION = 60; // 60s (生产真测 300s 太长, 用 60s 验证稳定性)
const CONNECTIONS = 100;
const OUT_MD = 'docs/online/PERF-STRESS-100.md';
const OUT_JSON = 'docs/online/perf-stress-100-results.json';

console.log('=== SimpleAgent 100 并发稳定性压测 ===\n');
